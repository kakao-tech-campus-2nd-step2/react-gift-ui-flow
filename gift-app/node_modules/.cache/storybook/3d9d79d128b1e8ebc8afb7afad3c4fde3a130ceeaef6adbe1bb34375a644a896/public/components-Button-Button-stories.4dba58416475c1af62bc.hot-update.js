...
const Button = ({
  ...
  const mode = theme ? `button--${theme.toLowerCase()}-${primary ? 'primary' : 'secondary'}` : '';
...
//# sourceMappingURL=components-Button-Button-stories.4dba58416475c1af62bc.hot-update.js.map