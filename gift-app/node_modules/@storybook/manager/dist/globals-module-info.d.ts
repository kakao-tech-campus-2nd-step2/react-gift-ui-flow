...
declare const globalsModuleInfoMap: Required<Record<"react" | "react-dom" | "@storybook/components" | "@storybook/channels" | "@storybook/core-events" | "@storybook/core-events/manager-errors" | "@storybook/router" | "@storybook/theming" | "@storybook/icons" | "@storybook/manager-api" | "@storybook/client-logger" | "@storybook/types", Required<ModuleInfo>>>;
